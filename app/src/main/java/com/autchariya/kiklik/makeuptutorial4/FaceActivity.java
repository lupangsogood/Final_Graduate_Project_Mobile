...
public class FaceActivity extends AppCompatActivity {
    ...
    private  String valModeStyle;
    public ImageView imageView;
    public FabSpeedDial btn_leftCheek;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //FabSpeedDial fab = findViewById(R.id.btn_Mode1_Style1);


        imageView = findViewById(R.id.gifImageView);
        btn_leftCheek = findViewById(R.id.btn_Mode1_Style1);


        Resources r = getResources();
        int[] base = r.getIntArray(R.array.fab_menu_item_colors);
    ...
    protected void onResume() {
        ...
        Toast.makeText(this,valModeStyle , Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onSaveInstanceState(Bundle saveInstanceState) {
        ...
        saveInstanceState.putBoolean("IsFrontFacing",mIsFrontFacing);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode != RC_HANDLE_CAMERA_PERM) {
            Log.d(TAG, "Got_unexpected permission result: " + requestCode);
    ...
    private FaceDetector createFaceDetector(final Context context){
        ...
        MultiProcessor.Factory<Face> factory = new MultiProcessor.Factory<Face>() {
            ...
            public Tracker<Face> create(Face face) {
                return new FaceTracker(mGraphicOverlay, context, mIsFrontFacing,imageView,btn_leftCheek);
